...
public class PlayerControllerTest {
	...
	public void login_wrongUsername() throws Exception {
		...
		mockMvc.perform(request)
				...
				.andExpect(result -> assertTrue(result.getResolvedException().getMessage()
						.contains("The credentials don't allow you to log in!")));
	}
	...
	public void getUser_withId_notFound() throws Exception {
		...
		given(playerService.getPlayer(Mockito.anyLong())).willThrow(e);
	 ...
	 * can be processed
	 * Input will look like this: {"name": "Test Player", "username":
	 * "testUsername"}
	 *
	 * @param object
	 * @return string
