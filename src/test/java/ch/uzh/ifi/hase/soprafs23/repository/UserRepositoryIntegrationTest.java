...
public class UserRepositoryIntegrationTest {
    ...
    @Test
    public void getPointsCurrentRoundUsers(){
        User testUser = new User();
        testUser.setPassword("testPassword");
        testUser.setUsername("testUsername");
        testUser.setHighScore(10);
        ...
        testUser.setStatus(UserStatus.ONLINE);
        testUser.setToken("1");
        testUser.setLobbyID(99);
        testUser.setPointsCurrentRound(22);
        ...
        testUser2.setStatus(UserStatus.ONLINE);
        testUser2.setToken("2");
        testUser2.setLobbyID(88);
        testUser2.setPointsCurrentRound(33);
        ...
        testUser3.setStatus(UserStatus.ONLINE);
        testUser3.setToken("3");
        testUser3.setLobbyID(99);
        testUser3.setPointsCurrentRound(44);
        ...
        List<User> users = userRepository.findByLobbyIDOrderByPointsCurrentRoundDesc(99);
        assertEquals(users.get(0),testUser3);
        assertEquals(users.get(1),testUser);
    }

    @Test
    public void getPointsCurrentGameUsers(){
        User testUser = new User();
        testUser.setPassword("testPassword");
        testUser.setUsername("testUsername");
        testUser.setHighScore(10);
        ...
        testUser.setToken("1");
        testUser.setLobbyID(99);
        testUser.setPointsCurrentGame(22);
        ...
        testUser2.setToken("2");
        testUser2.setLobbyID(88);
        testUser2.setPointsCurrentGame(33);
        ...
        testUser3.setToken("3");
        testUser3.setLobbyID(99);
        testUser3.setPointsCurrentGame(44);
        ...
        List<User> users = userRepository.findByLobbyIDOrderByPointsCurrentGameDesc(99);
        assertEquals(users.get(0),testUser3);
        assertEquals(users.get(1),testUser);
    }
